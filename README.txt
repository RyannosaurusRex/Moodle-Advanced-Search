...
* Rename the advancedorgsearch/ folder to the name of your module (eg "widget").
...
* Edit all the files in this directory and its subdirectories and change
  all the instances of the string "advancedorgsearch" to your module name
  (eg "widget"). If you are using Linux, you can use the following command
  $ find . -type f -exec sed -i 's/advancedorgsearch/widget/g' {} \;
  
  On a mac, use:
  $ find . -type f -exec sed -i '' 's/advancedorgsearch/widget/g' {} \;

* Rename the file lang/en/advancedorgsearch.php to lang/en/widget.php
...
* Go to Site Administration > Plugins > Activity modules > Manage activities
  and you should find that this advancedorgsearch has been added to the list of
  installed modules.
